<template>
  <div>
    <h1 class="mb-10 text-4xl">Compra de productos</h1>
    <div>
    ...
    <div>
      <input
        class="w-1/2 h-12 px-4 mb-2 text-lg text-gray-700 placeholder-gray-600 border rounded-lg  focus:shadow-outline"
        id="price"
        type="number"
        v-model="price"
        readonly
    ...
    <div v-show="quantity > 0">
      ...
      >
        <div class="px-7">¿Está seguro de la compra que va a realizar?</div>
      </vue-modal-2>
    </div>
  </div>
</template>
